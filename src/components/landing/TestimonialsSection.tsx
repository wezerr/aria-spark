...
const testimonials = [
  {
    rating: 5,
    text: 'Resume AI помог мне создать идеальное резюме за считанные минуты. AI-ассистент дал отличные советы по улучшению текста. Получил 3 приглашения на собеседования в первую неделю!',
    name: 'Иван Петров',
  ...
  {
    rating: 5,
    text: 'Использовал множество сервисов для создания резюме, но Resume AI - лучший! Интуитивный интерфейс и мощный AI-ассистент делают процесс быстрым и приятным.',
